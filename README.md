...
public class Simulador_Fut {
    ...
    public static void times() {
        ...
        // função para ler o time escolhido pelo usuario e o time de seu adversario 
    ...
    // escolher o seu time que quer jogar 
    ...
    // escolher ou configurar time adversario 
    public static void menu()throws InterruptedException {
        ...
        while (true) {
            ...
            if (opcoes == 1) {
                ...
                System.out.println("Escolha seu time , o time adversário , selecione os pontos lembrando a soma deve ser 21 nem > nem < e aí só acompanhar a simulação que vai estar acontecendo.");
    ...
    public static void iniciarJogo()throws InterruptedException {
        ...
        for (int tempo = 1; tempo <= 90; tempo++) {
            ...
            if (posseDaBola == 0) {
                System.out.println("a bola esta na posiçao " + posicaoBola + " com o " + nomeTime + " no minuto " + tempo);

            }else{
              System.out.println("a bola esta na posiçao " + posicaoBola + " com o " + nomeTimeAdversario + " no minuto " + tempo);
        ...
        System.out.println(" O placar final: " + nomeTime + " " + golsTime0 + " X " + golsTime1 + " " + nomeTimeAdversario);
    ...
    // sorteio para ver qual posição a bola vai! 
    public static int movimentarBola(int quem_ganhou, int posicaoBola) {
        ...
        // compara uma posição , cria um vetor de possibilidades para aonde a bola pode ir nessa posição , faz um sorteio entre as posibilidades
    public static void reimprimir(int posicaoBola, int posseDaBola)throws InterruptedException { 
    ...
    // compara a posição e a posse de bola para saber aonde imprimir a bola 

    public static void main(String[] args)throws InterruptedException { 
        menu(); // chama menu , pois , é a primeira coisa que vai aparecer , e é nele que vai chamar quase todas as outras funções.
